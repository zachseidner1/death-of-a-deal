...
<tileset version="1.10" tiledversion="1.10.2" name="stonetileset" tilewidth="16" tileheight="16" tilecount="9" columns="3">
 <image source="stonetileset.PNG" width="48" height="48"/>
 <wangsets>
