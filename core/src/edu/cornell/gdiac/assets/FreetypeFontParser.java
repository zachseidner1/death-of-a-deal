 ...
 * values of the same name. It is also possible to specify a texture by simply giving the name of
 * the file.  In that case, the default parameters will be used on loading.
 * <p>
 * This class only works for TrueType fonts.  You must create another parser for alternate font
 * representations.
 */
public class FreetypeFontParser implements AssetParser<BitmapFont> {
   ...
   * <p>
   * The parser converts JSON entries into {@link FreetypeFontLoader.FreeTypeFontLoaderParameter}
   * values of the same name. The file will be the contents of the file entry.  The key will be the
   * name of the font object.
   * <p>
   * If the JSON value is a string and not an object, it will interpret that string as the file and
  ...
  public void processNext(AssetManager manager, ObjectMap<String, String> keymap) {
    ...
    if (root.isString()) {
      ...
      params.fontParameters.hinting = ParserUtils.parseHinting(root.get("hinting"),
      ...
      params.fontParameters.borderColor = ParserUtils.parseColor(root.get("borderColor"),
          Color.BLACK);
      ...
      params.fontParameters.shadowColor = ParserUtils.parseColor(root.get("shadowColor"),
      ...
      params.fontParameters.minFilter = ParserUtils.parseFilter(root.get("minFilter"),
          Texture.TextureFilter.Linear);
      params.fontParameters.magFilter = ParserUtils.parseFilter(root.get("magFilter"),
          Texture.TextureFilter.Linear);
