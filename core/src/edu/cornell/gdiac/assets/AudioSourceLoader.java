 ...
 */
public class AudioSourceLoader extends
    AsynchronousAssetLoader<AudioSource, AudioSourceLoader.AudioSourceParameters> {
   ...
   */
  @Override
  public AudioSource loadSync(AssetManager manager, String fileName, FileHandle file,
      AudioSourceParameters params) {
