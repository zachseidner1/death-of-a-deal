 ...
 * <p>
 * A texture region asset should be specified by filename:name where name is a unique name for the
 * region.
 */
public class TextureRegionLoader extends
    AsynchronousAssetLoader<TextureRegion, TextureRegionLoader.TextureRegionParameters> {
   ...
   */
  @Override
  public TextureRegion loadSync(AssetManager manager, String fileName, FileHandle file,
      TextureRegionParameters params) {
   ...
   * <p>
   * A texture region is a texture plus a rectangle.  This parameter defines both those values
   * (through a symbolic link to the texture in this manager).  A texture region is fully defined by
   * these parameters.  The file name is just a symbolic reference.
   */
