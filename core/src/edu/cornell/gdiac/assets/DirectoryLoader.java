 ...
 * <p>
 * This is the "top-level" loader for {@link AssetDirectory}. It is necessary to load the initial
 * directory JSON.  But it also has integrated {@link AssetParser} objects to turn to contents of
 * that JSON into more assets.
 */
public class DirectoryLoader extends
    AsynchronousAssetLoader<AssetDirectory.Index, DirectoryLoader.DirectoryLoaderParameters> {
   ...
   * <p>
   * If there are no asset parsers, then no assets will be generated beyond the initial JSON file.
   * The contents of the JSON file will be ignored.
   * <p>
   ...
   */
  @Override
  public AssetDirectory.Index loadSync(AssetManager manager, String fileName, FileHandle file,
      DirectoryLoaderParameters params) {
   ...
   */
  public static class DirectoryLoaderParameters extends
      AssetLoaderParameters<AssetDirectory.Index> {
