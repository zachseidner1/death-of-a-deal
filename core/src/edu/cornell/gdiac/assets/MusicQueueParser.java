 ...
 * <p>
 * The music buffer created does not need to contain any {@link AudioSource} objects. However, you
 * can initialize sources in the sources tag with an array of file names.
 */
public class MusicQueueParser implements AssetParser<MusicQueue> {
   ...
   * <p>
   * The parser converts JSON entries into {@link MusicQueueLoader.MusicBufferParameters} values of
   * the same name. The file will be the contents of the file entry.  The key will be the name of
   * the font object.
   * <p>
