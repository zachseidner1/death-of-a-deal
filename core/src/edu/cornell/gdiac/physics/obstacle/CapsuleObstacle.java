...
public class CapsuleObstacle extends SimpleObstacle {
   ...
   * <p>
   * The orientation of the capsule will be a full capsule along the major axis.  If width ==
   * height, it will default to a vertical orientation.
   * <p>
   ...
   * <p>
   * If the center rectangle is exactly the same size as the circle radius, you may get catching at
   * the seems.  To prevent this, you should make the center rectangle epsilon narrower so that
   * everything rolls off the round shape. This parameter is that epsilon value
   *
