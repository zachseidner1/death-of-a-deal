 ...
 * <p>
 * The existing Controllers class has been known to segfault on some systems due to the native
 * libraries that it uses.  We need a way to "turn it off" in that case. This wrapper does just
 * that, as it controls access via the GDXAppSettings value.
 */
public class Controllers {
   ...
   * <p>
   * If the wrapper is not active, the array will be empty. This method should only be called on the
   * rendering thread.
   *
   ...
   * <p>
   * This listener can react to events from all {@link Controller} instances. However, no listener
   * will be added The listener will be added if the wrapper is not active. This method should only
   ...
   * <p>
   * No listener will be added The listener will be removed if the wrapper is not active. This
   * method should only be invoked on the rendering thread.
   *
   ...
   * <p>
   * If the wrapper is not active, the array will be empty. This method should only be called on the
   * rendering thread. Modifying this array will result in undefined behaviour.
   *
