  ...
  * <p>
  * This class supports O(1) deletion for internal nodes.  Simply use the entryIterator() method to
  * access the Entry nodes directly.
  */
 public class PooledList<E> extends AbstractSequentialList<E> implements Iterable<E> {
    ...
    * <p>
    * This class does no preallocate, but will reuse objects that have been freed.
    */
